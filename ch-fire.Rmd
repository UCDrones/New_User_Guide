...
- During flight operations:
    ...
    - Ensure that a crew member has easy access to reach any location where the \gls{UA} may crash.
...
- When flying in high fire risk locations, use high quality, commercially available \gls{UA} with enclosed electronics.
