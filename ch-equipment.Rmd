...
**Mavic 3** - The [DJI Mavic 3](https://store.dji.com/product/dji-mavic-3) is a great drone. It boasts a 45 minute flight time, a great camera, zoom up to 28x and almost all the features you could want from a drone - except its not compatible with mapping software.  If you're just doing cinematography, its a good albeit pricey option at \$2k (\$2.8k with the extra battery combo pack).

**Mavic 3 Classic** - The [DJI Mavic 3 Classic](https://store.dji.com/product/dji-mavic-3-classic) is a cheaper model of the Mavic 3 without some of the advanced camera features.  It's still a great drone and a great flier, and at a more affordable cost. It also an optional upgrade for an all-in-one RC controller that removes the need for using your phone or tablet when flying.
...
**Skydio 2+** - The [Skydio](https://www.skydio.com/) is the only non-DJI drone compatible with DroneDeploy.  It's smaller than a Mavic, and the camera is not as high quality, but as DJI moves away from compatibility with mapping software, it's worth checking out for basic/simple flight missions.

**Autel Robotics EVO II** - Autel has been in the drone business almost as long as DJI, but only its recent models have begun to get mainstream attention.  The newer [Evo II Pro](https://shop.autelrobotics.com/collections/drones-evo-ii-series) models are a worthy Mavic competitor and unlike the DJI drones, has mapping software functionality built-in. 
