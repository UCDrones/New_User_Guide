...
\item
  \protect\hyperlink{ch-TRUST}{TRUST Certificate}
\end{itemize}
...
\item
  \protect\hyperlink{ch-UCDrones-project}{Creating a flight request}
\item
...
\hypertarget{ch-TRUST}{%
\chapter{The Recreational UAS Safety Test}\label{ch-TRUST}}
...
\section{What is TRUST?}\label{what-is-trust}}
...
\section{How Can I Take the TRUST}\label{how-can-i-take-the-trust}}
...
\section{Who made the TRUST?}\label{who-made-the-trust}}
...
\section{What does the TRUST certificate look like?}\label{what-does-the-trust-certificate-look-like}}
...
\hypertarget{ch-tips}{%
\chapter{Top 10 Safety Tips}\label{ch-tips}}
...
\section{Drone Fire Safety Bucket}\label{drone-fire-safety-bucket}}
