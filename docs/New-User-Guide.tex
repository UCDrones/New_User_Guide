...
\hypertarget{where-can-i-fly}{%
\chapter{Where can I fly?}\label{where-can-i-fly}}

Once you have your drone registered with both the FAA and the Uc System, you might be asking yourself, ``Now where can I actually fly on campus?''. The answer to this tends to be a bit dynamic and can depend on \emph{why} you're flying. If your flights are for recreational purposes then you might find
...
\tightlist
\item
  Make sure everyone is safe and that there were no injuries before proceeding.
\item
  Approach and inspect crash site. Are the damages
\item
  Make notes of possible damages and take pictures of site.
\item
  Closely inspect your UAV to ensure status.
\item
  IF the crash injured an individual or severely damaged the aircraft and possibly caused over \$500 in damages:
\end{enumerate}
...
\tightlist
\item
  IF after careful inspection there were no injuries or damages AND the drone is deemed flyable may you take back to the skies.
\end{enumerate}
