...
The process to take the drone exam is a bit more complicated than just signing up for it. We'll walk through the process, but for more details, you can visit the FAA's website here: \href{https://www.faa.gov/uas/commercial_operators/become_a_drone_pilot/}{Becoming a Drone Pilot}
...
\item
  After you complete the test, you'll need to register your score with the FAA on a system called \textbf{IACRA}. Don't worry, your testing center will provide you with the instructions on how to do this.
\end{enumerate}
