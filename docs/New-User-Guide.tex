...
\subsection{What are the stipulations for `Recreational' and approved `Academic' activities?}\label{what-are-the-stipulations-for-recreational-and-approved-academic-activities}}
...
\hypertarget{TRUST}{%
\section{The Recreational UAS Safety Test}\label{TRUST}}
...
\hypertarget{how-can-i-take-the-trust}{%
\subsection{How Can I Take the TRUST}\label{how-can-i-take-the-trust}}
...
\hypertarget{who-made-the-trust}{%
\subsection{Who made the TRUST?}\label{who-made-the-trust}}
...
\hypertarget{what-does-the-trust-certificate-look-like}{%
\subsection{What does the TRUST certificate look like?}\label{what-does-the-trust-certificate-look-like}}
...
The use of UC Drones Web App is UC UAS Policy compliant. However, it is not the only means of UC UAS Policy compliance. If alternative means of UC UAS Policy is needed or requested, please contact your campuses' drone Point of Contact
...
Requirements\strut
\end{minipage} & \begin{minipage}[b]{0.20\columnwidth}\centering
With Remote ID\strut
\end{minipage} & \begin{minipage}[b]{0.32\columnwidth}\centering
Without Remote ID\strut
...
\textbf{Cat 1}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\centering
Under 0.55 lbs Prop Guards\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\centering
In transit flights over people Flights over open air assemblies\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\centering
In transit flights over people Only in FRIAs (2023)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.16\columnwidth}\raggedleft
\textbf{Cat 2}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\centering
FAA certification Not cause a severe injury Prop Guards\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\centering
In transit flights over people Flights over open air assemblies\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\centering
In transit flights over people Only in FRIAs (2023)\strut
...
\textbf{Cat 3}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\centering
FAA certification Not cause a fatal injury Prop Guards\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\centering
In transit flights over people Flights over consenting open air assemblies\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\centering
In transit flights over people Only in FRIAs (2023)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.16\columnwidth}\raggedleft
\textbf{Cat 4}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\centering
FAA Airworthiness Certification\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\centering
In transit flights over people Flights over open air assemblies\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\centering
In transit flights over people Only in FRIAs (2023)\strut
