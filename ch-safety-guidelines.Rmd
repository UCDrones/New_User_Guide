...
- Establish a **buffer** or **safe-zone** between the Unmanned Aircraft and any non-participating persons or sensitive locations. A good rule-of-thumb is to maintain a buffer or safe-zone of **roughly $\frac{1}{4}^{th}$ of the flight altitude**.
